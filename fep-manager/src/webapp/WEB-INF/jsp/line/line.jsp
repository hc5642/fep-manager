...
function inputValues() {
	...
	if ( input === "D" ) {
		document.getElementById("insert_kbkIp").innerText = "172.20.192.11";
		document.getElementById("insert_kbkNatIp").innerText = "172.16.220.10";
	} else if ( input === "P" ) {
		document.getElementById("insert_kbkIp").innerText = "172.24.192.11\n172.24.192.12";
		document.getElementById("insert_kbkNatIp").innerText = "10.16.240.10";
	}
}
function toExcel() {
